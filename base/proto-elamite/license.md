...
The glyph shapes in this font are derived from the CDLI proto-Elamite
sign list at https://github.com/cdli-gh/proto-elamite_data, copyright
Cuneiform Digital Library Initiative (CDLI), licensed under the Creative
Commons Attribution 4.0 International License (CC-BY-4.0),
https://creativecommons.org/licenses/by/4.0/. The original vector signs
were converted, cleaned, and re-fit for use as a font. Attribution to
CDLI is required when using or redistributing these glyphs.
