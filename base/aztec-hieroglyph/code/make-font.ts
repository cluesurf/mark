...
// All Aztec SVGs share the same height but vary in width.
...
async function main() {
  ...
  // Glyphs are named by their syllable (a, ka, ka', tla, ...), so
  // order them alphabetically for a stable codepoint assignment.
