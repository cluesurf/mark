...
// Linear B blocks (Syllabary + Ideograms), starting at U+10000.
// The 185 glyphs exceed a single 128-slot block, so they span from
// the Syllabary (U+10000) into the Ideograms block.
const LINEAR_B_BASE = 0x10000

// All Isthmian SVGs share the same height but vary in width.
